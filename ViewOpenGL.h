...
#include "Surface_Algorithm/AABB_Tree/TinyVector.h"
#if __linux__
...
public:
	...
	//void SetDrawModule (const FaceType &module);
...
protected:
    ...
    void ViewTranslation (const QPoint &p);
    ...
    virtual void ViewTranslate(const Vector3d &trans);
...
protected:
    ...
    QMatrix4x4 tempViewRotateMatrix;
